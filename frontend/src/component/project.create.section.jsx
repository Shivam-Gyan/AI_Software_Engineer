        ...
        <section className='py-20'>
            ...
            <div className='flex flex-col items-center justify-center max-h-full '>
                ...
                <form className='flex flex-col items-center justify-center mt-7 '>
                    <div className='flex items-center max-w-80 gap-4 px-3 py-2 justify-between border-2 w-[50vh] border-indigo-300 rounded-lg'>
                        <input onKeyDown={(e) => {
                            if (e.key === 'Enter') {
                                handleProjectCreation(e)
                            }
                        }} type='text' placeholder='project Name' className='outline-none px-3 py-2' value={projectName} onChange={(e) => setProjectName(e.target.value)} />
