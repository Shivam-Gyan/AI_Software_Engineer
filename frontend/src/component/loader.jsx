...
const Loader = () => {
    return (
        // <div className=" items-center block max-w-sm p-6 bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-700">
        ...
        // </div>
            <div role="status" className=" absolute -translate-x-1/2 -translate-y-1/2 top-[40%] left-1/2">
